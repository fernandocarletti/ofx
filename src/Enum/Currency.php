...
/**
 * ISO 4217 currency codes supported by OFX.
 *
 * Used for specifying currency in financial transactions and amounts.
 */
enum Currency: string
{
    ...
    case STN = 'STN'; // Sao Tome and Principe Dobra
    ...
    case VES = 'VES'; // Venezuelan Bolivar Soberano
